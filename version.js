/* ════════════════════════════════════════════════════════════════════════
   ExerciseLog — single global version constant.
   ...
   The auto-update poller fetches THIS file and looks for the literal
   substring "APP_VERSION = '<target>'".

   Workflow on every deploy:
     1. Edit window.APP_VERSION here.
     2. UPDATE apa_core.apps SET version=$NEW WHERE app_name='ExerciseLog'.
     3. git push.
   ════════════════════════════════════════════════════════════════════════ */
